...
import { feedbackpost } from '../Redux/FeedbackReducer/action';
  const confetti = {
    light: {
                  ...
                  <VStack spacing={5}>
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        ...
                        <Input type="text" name="name" value={feedback.name} placeholder="Your Name" onChange={handleChange} />
                      </InputGroup>
                    </FormControl>
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input type="link" name="image" placeholder="Enter an Image if any" value={feedback.image} onChange={handleChange} />
                      </InputGroup>
                    </FormControl>
